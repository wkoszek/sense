...
| `samples` | Synthesize one passage across N voices into a single self-contained HTML page with inline players (`-n`, `--all`) — the fastest way to hear premium vs default |
